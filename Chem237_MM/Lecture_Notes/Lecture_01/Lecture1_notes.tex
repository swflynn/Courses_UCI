...
\ee
Is a homogenous equation, however
\be
\frac{d^2y}{dx^2} + d\frac{dy}{dx} + x = 0
\ee
The equation is an inhomogenous differential equation (x has no depeddence on y). 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.7]{Figures/morse.png}
  \caption{ }
  \label{fig:morse}
\end{figure}
%==============================================================================%
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.7]{Figures/piecewise.png}
  \caption{ }
  \label{fig:piecewise}
\end{figure}
%==============================================================================%

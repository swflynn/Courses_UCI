...
If we wanted to find the n-th term of a Fourier series, we can consider projecting the cosine vector $\bra{c_n}$ onto the n-th term of our $\ket{f(\theta)}$ vector (remember, projection means dot product), we get,
\be

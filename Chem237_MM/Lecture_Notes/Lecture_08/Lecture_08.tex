...
If we project the cosine vector $\bra{c_n}$ onto our $\ket{f(\theta)}$ vector (remember, projection means dot product), we get,
\be
  \braket{c_n|f(\theta)} = \bra{c_n} \Big(\sum_{n=0}^{\infty} A_n \ket{c_n} + B_n \ket{s_n} \Big) = \sum_{n=0}^{\infty} A_n \braket{c_n|c_n} + B_n \braket{c_n|s_n}
\ee
...
\ee
If we project the sine vector $\bra{s_n}$ onto our $\ket{f(\theta)}$ vector, we get,
\be
  \braket{s_n|f(\theta)} = \bra{s_n} \Big(\sum_{n=0}^{\infty} A_n \ket{c_n} + B_n \ket{s_n} \Big) = \sum_{n=0}^{\infty} A_n \braket{s_n|c_n} + B_n \braket{s_n|s_n}
\ee
